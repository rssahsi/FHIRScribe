...
master_grab.open("GET", "https://rssahsi.github.io/FHIRScribe/PDF/master.json", true);
    ...
    function onReady(smart)  {
      ...
      if (smart.hasOwnProperty('patient')) {
        ...
        $.when(pt, obv, userId).done(function(patient, obv, userId) {
          ...
          // *** you'll want the health card number + version code *** //

          // *** you'll want to find some sort of MRN *** //
...
//          p.height = getQuantityValueAndUnit(height[0]);
          ...
          // *** surprise, the LHIN med form wants height and weight *** //
